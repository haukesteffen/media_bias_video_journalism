...
sns.scatterplot(x=xs_cv, y=ys_cv, hue=y, ax=axs[0, 0], palette="RdBu").set(
    title="Count Vectorizer"
)
sns.scatterplot(x=xs_tfidf, y=ys_tfidf, hue=y, ax=axs[0, 1], palette="RdBu").set(
    title="TFIDF Vectorizer"
)
sns.scatterplot(x=xs_we, y=ys_we, hue=y, ax=axs[1, 0], palette="RdBu").set(
    title="Spacy Word Embeddings Vectorizer"
)
sns.scatterplot(x=xs_hv, y=ys_hv, hue=y, ax=axs[1, 1], palette="RdBu").set(
